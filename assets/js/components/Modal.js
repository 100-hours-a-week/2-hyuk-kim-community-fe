class Modal extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.shadowRoot.querySelector('#cancel').onclick = () => {this.handleCancel();};
        this.shadowRoot.querySelector('#ok').onclick = () => {this.handleOk();};
    }
    ...
    handleOk() {
        this.closeModal();
        this.dispatchEvent(new CustomEvent('modal-ok', { bubbles: true, composed: true }));
    }
}
