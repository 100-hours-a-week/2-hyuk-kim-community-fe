...
class HeaderComponent extends HTMLElement {
    ...
    connectedCallback() {
        ...
        this.shadowRoot.querySelector('#menu-edit-profile').onclick = () => {
            window.location.href = 'EditProfile.html';
        };
        this.shadowRoot.querySelector('#menu-edit-password').onclick = () => {
...
function checkReferrer() {
    ...
    console.log(
        'buttonBack: ' + buttonBack + ' / buttonProfile: ' + buttonProfile,
    );
    console.log('pageNow: ' + pageNow);
    if (
        pageNow.includes('LoginPage') ||
        pageNow.includes('EditProfilePage') ||
        pageNow.includes('EditPasswordPage') ||
        pageNow.includes('Posts')
    ) {
